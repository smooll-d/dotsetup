...
__dotsetup_execute '__dotsetup_backup_files /etc/X11/xorg.conf.d/10-extensions.conf'
...
__dotsetup_execute 'sudo rsync -av ${__dotsetup_dotfiles_directory}/etc/X11/xorg.conf.d/10-extensions.conf /etc/X11/xorg.conf.d/10-extensions.conf'
